...
"""
import unittest
from zfs_tools.models import PoolSet
from zfs_tools import sync


def x(string):
    return "\n".join(["\t".join(x.split()) for x in string.splitlines()])
...
"""
        ...
        result = sync.recursive_replicate(
            src.lookup("karen"), dst.lookup("target/karen")
        )
...
"""
        ...
        real = sync.recursive_replicate(src.lookup("s"), dst.lookup("t/s"))
...
"""
        ...
        expected = [
            ...
            ("create_stub", src.lookup("s/c"), None, None, None),
        ]
        expected_coalesced = (
            expected[0:2]
            + [
...
"""
        ...
        expected = [
            ("full", src.lookup("s"), dst.lookup("t/s"), None, src.lookup("s@1")),
            (
                "incremental",
                src.lookup("s"),
                dst.lookup("t/s"),
...
"""
        ...
        expected = [
            ...
            ("create_stub", src.lookup("s/b/x"), None, None, None),
            ("create_stub", src.lookup("s/c"), None, None, None),
        ]
        expected_coalesced = [
            (
...
"""
        ...
        expected = [
            ("create_stub", src.lookup("s/a"), None, None, None),
            ("create_stub", src.lookup("s/a/x"), None, None, None),
            ("full", src.lookup("s/a/x/t"), None, None, src.lookup("s/a/x/t@1")),
            (
                "incremental",
                src.lookup("s/a/x/t"),
                None,
    ...
    def test_replicates_complex_datasets(self):
        ...
        expected = [
            ...
            ("create_stub", src.lookup("karen/ROOT/fedora/tmp"), None, None, None),
            (
                "incremental",
            ...
            ("create_stub", src.lookup("karen/sekrit"), None, None, None),
            ("create_stub", src.lookup("karen/sekrit/f-business"), None, None, None),
            ("create_stub", src.lookup("karen/sekrit/f-proxy"), None, None, None),
            ("create_stub", src.lookup("karen/sekrit/f-storefront"), None, None, None),
            (
                "full",
            ...
            ("create_stub", src.lookup("karen/sekrit/f-tinc"), None, None, None),
            ("create_stub", src.lookup("karen/sekrit/f-vpn"), None, None, None),
            ("create_stub", src.lookup("karen/sekrit/f-wallet"), None, None, None),
            ("create_stub", src.lookup("karen/swap"), None, None, None),
        ]
        expected_coalesced = [
            (
                "incremental",
        ...
        real = sync.recursive_replicate(
            src.lookup("karen"), dst.lookup("backup/karen.dragonfear/karen")
        )
        self.assertEqual(expected, real)
...
"""
        ...
        self.assertEqual(result[0][0], "destroy")
        self.assertEqual(
            result[0][1].get_path(),
            "target/karen/plonezeo@zfs-auto-snap_hourly-2013-03-19-0000",
        )
